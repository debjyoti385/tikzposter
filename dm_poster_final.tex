...
\documentclass[20pt, a1paper, landscape, margin=0mm, innermargin=15mm,
blockverticalspace=15mm, colspace=15mm, subcolspace=8mm]{tikzposter}
% \documentclass{tikzposter} %Options for format can be included here
% \setcolumnnumber{3}
 % Title, Author, Institute
\title{\textbf{News Clustering and Event Detection}, Data Mining, Spring 2016}
...
\titlegraphic{
\includegraphics[width=0.13\textwidth]{figures/ulogo.png}
}
...
\renewcommand\TP@maketitle{%
   \centering
         \tikz[remember picture,overlay]\node[scale=0.8,anchor=east,xshift=0.46\linewidth,yshift=2.8cm,inner sep=0pt] {%
       \@titlegraphic
    };
...
\subcolumn{0.52}
\block[bodywidthscale=1]{Introduction}{
...
\block[bodywidthscale=1.02]{Dataset}{
...
1. The Better India \quad ~ 2. The Hindu \quad ~ 3. Times of India \\
\quad ~~~~~ 4. Economic Times  
\quad  5. Financial Express \quad 6.The Statesman  \\
\quad 7. Business Standard \quad 8. Assam Tribune
\quad 9. NDTV  \\
 \quad~~~~~~~~~ 10. Daily Excelsior \quad ~~ 11. First Post \quad ~~~~ 12. India Today
}
...
\block[titleoffsety=1.8cm,bodyoffsety=1.6cm]{Our Methods}{
        \vspace{-1.8cm}
...
%{
%                \textbf{Fine Grained Topic  $\rightarrow$  Broad Categorization}\\
...
%\note[targetoffsetx=21cm, targetoffsety=-0.3cm, angle=0, width=0.35\textwidth, rotate=0, roundedcorners=5, linewidth=0pt]
%{
%
%        \begin{center}
%%\begin{table}[H]
%%\label{broad_category}
%        \textbf{Temporal span}~~~~~ $|$ ~~~~~~~~~\textbf{Sliding Window} ~~~~~~~~$|$~~~~ \textbf{ Intra-Category } \\
%\begin{tabularx}{0.32\textwidth}{XXX} 
%        % \textbf{Temporal span}~~ &$|$ ~~\textbf{Sliding Window} ~~&$|$~~ \textbf{ Intra-Category } \\
...
\begin{minipage}[t]{\0.38\textwidth}
        \begin{center}
        \hspace{-3cm}
                ~~\textsc{\Large{Temporal span}}~~\quad $|$\quad ~~~~ \textsc{\Large{Sliding Window}} ~~~~$|$~~\quad \textsc{\Large{ Intra-Category }} \\
        \hspace{-6cm} An event usually has ~~~~~~~~~~~~ \quad  ~~~ Articles can merge to  \quad  ~~~~~~~~~~~~~~~~~~Related events  \\
        \hspace{-4.8cm} 3 days of temporal locality ~~~\quad ~~~~~~~previously detected events  \quad  ~~~~~~~~~~~under one category 
        \end{center}
\end{minipage}
}
...
\column{0.33}
\block{Architecture}{
\begin{tikzfigure}[Basic Event Detection Architecture ]
\label{fig:fig1}
\includegraphics[width=0.30\textwidth,height=12cm]{figures/EventDetection.png}
\end{tikzfigure}
...
\note[targetoffsetx=0cm, targetoffsety=-9.5cm, angle=-90, width=0.28\textwidth, rotate=0,]
{
...
{ % NEW NOTE STYLE
 \colorlet{notebgcolor}{white!10!white}
\note[targetoffsetx=0cm, targetoffsety=-23.2cm, angle=-90, width=0.33\textwidth, rotate=0,roundedcorners=0]{
\textbf{Citations:} \textit{(Detailed citations in report)}
\begin{enumerate}[noitemsep,nolistsep]
        ...
        \item \textit{Alfaro C, et.al}, A  multi-stage method for content classification and opinion mining on weblog comments.
\end{enumerate}
